<template>
  <div
    class="rounded-lg p-3 shadow-lg flex space-x-3 border border-[#6B7A99]"
   
  >
    <div
      class="w-[52px] h-[52px] flex items-center justify-center rounded-full"
